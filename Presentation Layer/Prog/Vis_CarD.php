...
<!--  TABELLA COMPLETA -->
                ...
                <div class="box-body" id="tabella1" >
                   ...
                   <table id="example1" class="table table-bordered table-hover">
					...
					?>
							  ...
							  <!--<tr class="dati" style="cursor:pointer;"> -->
            ...
            <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Carico Didattico</h3>
                </div><!-- /.box-header -->
			<div class="box-body" >
                  <div class="row">
					...
					<script type="text/javascript">
                        ...
                        function mostraCaricoDid(datipass){
							...
							console.log("Username loggato: "+user);
                            
                            var dati=new FormData();
                            dati.append("user",user);
                            dati.append("id","caricoDidattico");
                            //alert(username);
                            httpRequest = new XMLHttpRequest();
                            httpRequest.onreadystatechange = creaGrafo;
                            httpRequest.open("POST","/PrdOLD/Application%20Layer/GestioneProgrammazioneDidattica/getCaricoDidattico.php",true);
                        ...
                        function creaGrafo(){
                            if(httpRequest.readyState == 4 && httpRequest.status == 200){
                                ...
                                console.log("Dati ricevuti: "+doughnut);
                                disegna(doughnut);
                             }
                        }
                var tela=0;      
